...
export const Label = styled.label(({ isStacked }) => [
  tw`flex mb-3 text-sm font-semibold`,
  isStacked ? tw`flex-col` : tw`items-center`,
]);

export const Input = styled.input(({ type }) => [
  tw`px-2 py-2 font-bold leading-tight border-gray-300 rounded shadow-sm focus:ring-accent focus:border-accent-dark text-primary-dark`,
